import type { OpenOctaConfig } from "../config/config.js";
...
export function listBindings(cfg: OpenOctaConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: OpenOctaConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OpenOctaConfig) {
