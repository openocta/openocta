...
export const BUILTIN_PROVIDERS: BuiltInProvider[] = [
  ...
  { id: "volces_ark", label: "火山方舟", envKey: "VOLCES_ARK_API_KEY", defaultModel: "ark-code-latest", baseUrl: "https://ark.cn-beijing.volces.com/api/coding/v3", defaultApi: "openai-completions" },
];
